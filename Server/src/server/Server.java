...
public class Server extends javax.swing.JFrame {
    ...
    private void open() {
        Data data = (Data) mod.getElementAt(list.getSelectedIndex());
            if (data.getStatus().equals("JPG")||data.getStatus().equals("PNG")||data.getStatus().equals("jpg")||data.getStatus().equals("png")||data.getStatus().equals("jpeg")||data.getStatus().equals("JPEG")) {
